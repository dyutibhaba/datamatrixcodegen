 ...
 */
public class DataMatrixEnhanced {

    private void generate(File outputFile, String encodeMsg) throws IOException {
        ...
        //Generate the dataMatrixCode
        bean.generateBarcode(canvas, encodeMsg);
    ...
    public static void main(String[] args) {
        try {
        	DataMatrixEnhanced app = new DataMatrixEnhanced();
            File outputFile = new File("C:\\caddok\\dmc.png");
            String uniqueId = "DuT00121211";
            app.generate(outputFile, uniqueId);
        } catch (Exception e) {
            e.printStackTrace();
            System.exit(-1);
        }
